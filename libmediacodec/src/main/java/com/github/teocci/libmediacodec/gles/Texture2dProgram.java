...
public class Texture2dProgram
{
    ...
    private int uKernelLoc;
    private int uTexOffsetLoc;
    private int uColorAdjustLoc;
    ...
    public Texture2dProgram(ProgramType programType)
    {
        ...
        uKernelLoc = GLES20.glGetUniformLocation(programHandle, "uKernel");
        if (uKernelLoc < 0) {
            ...
            uTexOffsetLoc = GLES20.glGetUniformLocation(programHandle, "uTexOffset");
            GlUtil.checkLocation(uTexOffsetLoc, "uTexOffset");
            uColorAdjustLoc = GLES20.glGetUniformLocation(programHandle, "uColorAdjust");
            GlUtil.checkLocation(uColorAdjustLoc, "uColorAdjust");
    ...
    public void setKernel(float[] values, float colorAdj)
    {
        ...
        //Log.d(TAG, "filt kernel: " + Arrays.toString(kernel) + ", adj=" + colorAdj);
    }
    ...
    public void setTexSize(int width, int height)
    {
        ...
        //Log.d(TAG, "filt size: " + width + "x" + height + ": " + Arrays.toString(texOffset));
    }
                     ...
                     float[] texMatrix, FloatBuffer texBuffer, int textureId, int texStride)
    {
        ...
        if (uKernelLoc >= 0) {
            GLES20.glUniform1fv(uKernelLoc, KERNEL_SIZE, kernel, 0);
            GLES20.glUniform2fv(uTexOffsetLoc, KERNEL_SIZE, texOffset, 0);
            GLES20.glUniform1f(uColorAdjustLoc, colorAdjust);
        }
