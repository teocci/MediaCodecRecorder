package com.github.teocci.mediacodec.views;
...
public class DonutProgress extends View
{
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        default_text_size = CameraUtils.sp2px(getResources(), 18);
        min_size = (int) CameraUtils.dp2px(getResources(), 100);
        default_stroke_width = CameraUtils.dp2px(getResources(), 10);
        default_inner_bottom_text_size = CameraUtils.sp2px(getResources(), 18);
    ...
    protected void initByAttributes(TypedArray attributes)
    {
        finishedStrokeColor = attributes.getColor(
                R.styleable.DonutProgress_donut_finished_color, default_finished_color);
        ...
        finishedStrokeWidth = attributes.getDimension(
                R.styleable.DonutProgress_donut_finished_stroke_width, default_stroke_width);
        ...
        innerBottomTextSize = attributes.getDimension(
                R.styleable.DonutProgress_donut_inner_bottom_text_size, default_inner_bottom_text_size);
        innerBottomTextColor = attributes.getColor(
                R.styleable.DonutProgress_donut_inner_bottom_text_color, default_inner_bottom_text_color);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(text, (getWidth() - textPaint.measureText(text)) / 2.0f,
        ...
        if (!TextUtils.isEmpty(getInnerBottomText())) {
            ...
            canvas.drawText(getInnerBottomText(), (getWidth() -
                            innerBottomTextPaint.measureText(getInnerBottomText())) / 2.0f,
